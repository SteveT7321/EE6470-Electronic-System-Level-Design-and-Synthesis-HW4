...
public:
	...
	addr_t mmFilter_start_addr = 0x73000000;
 	addr_t mmFilter_size = 0x01000000;
 	addr_t mmFilter_end_addr = mmFilter_start_addr + mmFilter_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > mmFilter_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	bus.ports[12] = new PortMapping(opt.mmFilter_start_addr, opt.mmFilter_end_addr);
